...
#python NextGIS_fires_daily_id.py --name MODIS --latmin 40 --lonmin 40 --latmax 60 --lonmax 60 --url elina-usmanova --login ***** --password ***** --parentid 617 --styleid 624
#python NextGIS_fires_daily_id.py --name VIIRS --latmin 40 --lonmin 40 --latmax 60 --lonmax 60 --url elina-usmanova --login ***** --password ***** --parentid 342 --styleid 350
